...
const defaultThemes: Theme[] = [
  ...
  },
  {
    ...
    name: 'Light',
    base: [
      { id: 'app-bg-color', name: 'app-bg-color', value: '#f4f5f5' },
      { id: 'app-accent-color', name: 'app-accent-color', value: '#75abbc' },
      {
        id: 'primary-text-color',
        name: 'primary-text-color',
        value: 'rgba(0,0,0, 0.88)',
      ...
      { id: 'error-text-color', name: 'error-text-color', value: '#f45d52' },
      {
        id: 'primary-button-bg-color',
        name: 'primary-button-bg-color',
        value: '#75abbc',
    ...
    panel: [
      { id: 'panel-bg-color', name: 'panel-bg-color', value: '#f4f5f5' },
      {
        id: 'panel-accent-color',
        name: 'panel-accent-color',
        value: '#75abbc',
    ...
    card: [
      { id: 'card-bg-color', name: 'card-bg-color', value: '#ffffff' },
      {
        id: 'card-accent-color',
        name: 'card-accent-color',
        value: '#75abbc',
