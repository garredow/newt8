...
const defaultThemes: Theme[] = [
  {
    ...
    values: {
      ...
      sidebarBgColor: {name: 'sidebar-bg-color', variable: 'sidebar-bg-color', value: '#ffffff'},
      sidebarAccentColor: {name: 'sidebar-accent-color', variable: 'sidebar-accent-color', value: '#75abbc'},
      sidebarDividerColor: {name: 'sidebar-divider-color', variable: 'sidebar-divider-color', value: 'rgba(0,0,0, 0.1)'},
      sidebarTitleTextColor: {name: 'sidebar-title-text-color', variable: 'sidebar-title-text-color', value: 'rgba(0,0,0, 0.88)'},
      sidebarPrimaryTextColor: {name: 'sidebar-primary-text-color', variable: 'sidebar-primary-text-color', value: 'rgba(0,0,0, 0.88)'},
      sidebarSecondaryTextColor: {name: 'sidebar-secondary-text-color', variable: 'sidebar-secondary-text-color', value: 'rgba(0,0,0, 0.5)'},
      sidebarPrimaryButtonBgColor: {name: 'sidebar-primary-button-bg-color', variable: 'sidebar-primary-button-bg-color', value: '#75abbc'},
      sidebarPrimaryButtonTextColor: {name: 'sidebar-primary-button-text-color', variable: 'sidebar-primary-button-text-color', value: 'rgba(0,0,0, 0.88)'},
      sidebarSecondaryButtonBgColor: {name: 'sidebar-secondary-button-bg-color', variable: 'sidebar-secondary-button-bg-color', value: '#d0d6dd'},
      sidebarSecondaryButtonTextColor: {name: 'sidebar-secondary-button-text-color', variable: 'sidebar-secondary-button-text-color', value: 'rgba(0,0,0, 0.88)'},
      sidebarWarningButtonBgColor: {name: 'sidebar-warning-button-bg-color', variable: 'sidebar-warning-button-bg-color', value: '#f6f862'},
      sidebarWarningButtonTextColor: {name: 'sidebar-warning-button-text-color', variable: 'sidebar-warning-button-text-color', value: 'rgba(0, 0, 0, 0.88)'},
      sidebarDangerButtonBgColor: {name: 'sidebar-danger-button-bg-color', variable: 'sidebar-danger-button-bg-color', value: '#f45d52'},
      sidebarDangerButtonTextColor: {name: 'sidebar-danger-button-text-color', variable: 'sidebar-danger-button-text-color', value: 'rgba(0,0,0, 0.88)'},
    }
  },
  {
    id: 'dark',
    ...
    values: {
      ...
      sidebarBgColor: {name: 'sidebar-bg-color', variable: 'sidebar-bg-color', value: '#1B1F22'},
      sidebarAccentColor: {name: 'sidebar-accent-color', variable: 'sidebar-accent-color', value: '#6A8D92'},
      sidebarDividerColor: {name: 'sidebar-divider-color', variable: 'sidebar-divider-color', value: 'rgba(255,255,255,.2'},
      sidebarTitleTextColor: {name: 'sidebar-title-text-color', variable: 'sidebar-title-text-color', value: 'rgba(255, 255, 255, 0.84)'},
      sidebarPrimaryTextColor: {name: 'sidebar-primary-text-color', variable: 'sidebar-primary-text-color', value: 'rgba(255, 255, 255, 0.84)'},
      sidebarSecondaryTextColor: {name: 'sidebar-secondary-text-color', variable: 'sidebar-secondary-text-color', value: 'rgba(255, 255, 255, 0.6)'},
      sidebarPrimaryButtonBgColor: {name: 'sidebar-primary-button-bg-color', variable: 'sidebar-primary-button-bg-color', value: '#6A8D92'},
      sidebarPrimaryButtonTextColor: {name: 'sidebar-primary-button-text-color', variable: 'sidebar-primary-button-text-color', value: 'rgba(255, 255, 255, 0.84)'},
      sidebarSecondaryButtonBgColor: {name: 'sidebar-secondary-button-bg-color', variable: 'sidebar-secondary-button-bg-color', value: '#222E2F'},
      sidebarSecondaryButtonTextColor: {name: 'sidebar-secondary-button-text-color', variable: 'sidebar-secondary-button-text-color', value: 'rgba(255, 255, 255, 0.84)'},
      sidebarWarningButtonBgColor: {name: 'sidebar-warning-button-bg-color', variable: 'sidebar-warning-button-bg-color', value: '#EAC948'},
      sidebarWarningButtonTextColor: {name: 'sidebar-warning-button-text-color', variable: 'sidebar-warning-button-text-color', value: 'rgba(0, 0, 0, 0.88)'},
      sidebarDangerButtonBgColor: {name: 'sidebar-danger-button-bg-color', variable: 'sidebar-danger-button-bg-color', value: '#A52422'},
      sidebarDangerButtonTextColor: {name: 'sidebar-danger-button-text-color', variable: 'sidebar-danger-button-text-color', value: 'rgba(255, 255, 255, 0.84)'},
    }
  },
  {
    id: 'cobalt2',
    ...
    values: {
      ...
      sidebarBgColor: {name: 'sidebar-bg-color', variable: 'sidebar-bg-color', value: 'rgb(15,53,75)'},
      sidebarAccentColor: {name: 'sidebar-accent-color', variable: 'sidebar-accent-color', value: '#ffc600'},
      sidebarDividerColor: {name: 'sidebar-divider-color', variable: 'sidebar-divider-color', value: 'rgba(255, 255, 255, 0.2)'},
      sidebarTitleTextColor: {name: 'sidebar-title-text-color', variable: 'sidebar-title-text-color', value: 'rgba(255, 255, 255, 0.88)'},
      sidebarPrimaryTextColor: {name: 'sidebar-primary-text-color', variable: 'sidebar-primary-text-color', value: 'rgba(255, 255, 255, 0.88)'},
      sidebarSecondaryTextColor: {name: 'sidebar-secondary-text-color', variable: 'sidebar-secondary-text-color', value: 'rgba(255, 255, 255, 0.6)'},
      sidebarPrimaryButtonBgColor: {name: 'sidebar-primary-button-bg-color', variable: 'sidebar-primary-button-bg-color', value: '#ffc600'},
      sidebarPrimaryButtonTextColor: {name: 'sidebar-primary-button-text-color', variable: 'sidebar-primary-button-text-color', value: 'rgba(0,0,0, 0.88)'},
      sidebarSecondaryButtonBgColor: {name: 'sidebar-secondary-button-bg-color', variable: 'sidebar-secondary-button-bg-color', value: '#1F4662'},
      sidebarSecondaryButtonTextColor: {name: 'sidebar-secondary-button-text-color', variable: 'sidebar-secondary-button-text-color', value: 'rgba(255, 255, 255, 0.88)'},
      sidebarWarningButtonBgColor: {name: 'sidebar-warning-button-bg-color', variable: 'sidebar-warning-button-bg-color', value: '#f5f749'},
      sidebarWarningButtonTextColor: {name: 'sidebar-warning-button-text-color', variable: 'sidebar-warning-button-text-color', value: 'rgba(0,0,0, 0.88)'},
      sidebarDangerButtonBgColor: {name: 'sidebar-danger-button-bg-color', variable: 'sidebar-danger-button-bg-color', value: '#A52422'},
      sidebarDangerButtonTextColor: {name: 'sidebar-danger-button-text-color', variable: 'sidebar-danger-button-text-color', value: 'rgba(255, 255, 255, 0.88)'},
    }
  },
];
